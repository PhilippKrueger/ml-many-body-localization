...
%todo: talk about expectations and other paper
...
%	\centering
%	\includegraphics[width=\linewidth]{../results/groundstates/N10n6_trainingset_groundstate_Wmax0.5}
%	\caption{Visualization of the ground state for a large block size $n=6$ in the ergodic phase.}
%	\label{fig:N10n6_trainingset_groundstate_Wmax0}
%\end{figure}
%\begin{figure}[H]
%	\centering
%	\includegraphics[width=\linewidth]{../results/groundstates/N10n6_trainingset_groundstate_Wmax8.0}
%	\caption{Visualization of the ground state for a large block size $n=6$ in the localized phase.}
%	\label{fig:N10n6_trainingset_groundstate_Wmax8}
%\end{figure}
%\begin{figure}[H]
%\centering
%\includegraphics[width=\linewidth]{../results/groundstates/N10n4_trainingset_groundstate_Wmax0.5}
%\caption{Visualization of the ground state for an intermediate block size $n=4$ in the ergodic phase.}
%\label{fig:N10n4_trainingset_groundstate_Wmax0}
%\end{figure}
%\begin{figure}[H]
%	\centering
%	\includegraphics[width=\linewidth]{../results/groundstates/N10n4_trainingset_groundstate_Wmax8.0}
%	\caption{Visualization of the ground state for an intermediate block size $n=4$ in the localized phase.}
%	\label{fig:N10n4_trainingset_groundstate_Wmax8}
%\end{figure}
%
%\begin{figure}[H]
%	\centering
%	\includegraphics[width=\linewidth]{../results/groundstates/N10n1_trainingset_groundstate_Wmax0.5}
%	\caption{Visualization of the ground state for the minimal block size $n=1$ in the ergodic phase.}
%	\label{fig:N10n1_trainingset_groundstate_Wmax0}
%\end{figure}
%\begin{figure}[H]
%	\centering
%	\includegraphics[width=\linewidth]{../results/groundstates/N10n1_trainingset_groundstate_Wmax8.0}
%	\caption{Visualization of the ground state for the minimal block size $n=1$ in the localized phase.}
%	\label{fig:N10n1_trainingset_groundstate_Wmax8}
%\end{figure}
