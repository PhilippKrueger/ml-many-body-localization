...
Figure \ref{fig:accuracy_loss_epochs} illustrates that the model is still not completely prone to overfitting. This can be accounted to the big model size in comparison to the sample size. Still, the accuracy reaches an acceptable optimum after 100 training epochs.%todo: number epochs optimum
...
\end{center}
\twocolumngrid
%todo: compare with introduction
